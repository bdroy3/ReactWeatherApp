...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactDom2.default.render(_react2.default.createElement(_Weather2.default, { theme: 'light' }), document.getElementById('root'));
	...
	var Weather = function (_Component) {
	  ...
	  function Weather(props) {
	    ...
	    _this.handleOnClick = function () {
	      ...
	      var theme = _this.state.theme === "light" ? "dark" : "light";
	      _this.setState({
	        theme: theme
	      });
	    };
	  ...
	  _createClass(Weather, [{
	    ...
	    value: function render() {
	      var theme = this.state.theme === "light" ? (0, _aphrodite.css)(_WeatherStyles2.default.light) : (0, _aphrodite.css)(_WeatherStyles2.default.dark);
	      return _react2.default.createElement(
	        'div',
	        { className: theme },
	        _react2.default.createElement(WeatherTitle, { title: 'I am the weather title' }),
	        'Hows the Weather?',
	        _react2.default.createElement(
	          'a',
	          { href: '#', onClick: this.handleOnClick },
	          this.props.theme
	        )
	      );
	    }
